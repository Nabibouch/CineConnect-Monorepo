...
function SignInPage() {
  return (
    <div className="min-h-screen flex">
      ...
      {/* RIGHT - BRAND PANEL */}
      <div className="hidden lg:flex flex-1 bg-blue-600 flex-col items-center justify-center p-12 text-white">
        <h2 className="text-4xl font-bold mb-4">Cinneconnect</h2>
