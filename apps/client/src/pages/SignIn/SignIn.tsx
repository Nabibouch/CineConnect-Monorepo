  ...
  return (
    <div className="min-h-screen flex flex-row items-center justify-center m-4 ">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="hidden md:flex items-center justify-center bg-gradient-to-br bg-slayer p-8">
          <div className="text-center">
            ...
            <h2 className="text-5xl font-bold text-white mb-3">Movie<span className="text-rose-500">Tune</span></h2>
