...
const Filmtheme = ( { title, image, bg_color= "bg-purple-500"}: Filmtheme) => {
    return(
        <div>
            <div className={`w-[146px] h-[56px] rounded-3xl ${bg_color} overflow-hidden relative transition-transform duration-300 ease-out hover:scale-[1.08] hover:-translate-y-2`}>
